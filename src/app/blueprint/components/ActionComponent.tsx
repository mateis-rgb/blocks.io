	...
	return (
		...
		<button
			className={clsx(
				...
				`text-${color}-500 dark:border-${color}-500 dark:text-${color}-500 dark:hover:text-gray-200 dark:focus:ring-${color}-800 focus:ring-${color}-300 hover:border-gray-200 border-${color}-500 hover:text-gray-200`,
				className
			)}
			onClick={handleClick}
		>
